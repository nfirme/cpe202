...
class TestHeap(unittest.TestCase):
    ...
    def test_full_heap(self):
        ...
        test_heap.enqueue(20)
        test_heap.enqueue(30)
        self.assertTrue(test_heap.is_full())
        self.assertFalse(test_heap.enqueue(40))
    ...
    def test_empty(self):
        ...
        test_heap.perc_down(1)
        empty_list = []
        test_heap.heap_sort_ascending(empty_list)
        self.assertEqual(empty_list, [])

    def test_too_big_list(self):
        test_heap = MaxHeap(5)
        self.assertEqual(test_heap.get_capacity(), 5)
        list1 = [10, 40, 30, 80, 60, 70]
