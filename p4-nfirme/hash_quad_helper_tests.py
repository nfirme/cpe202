...
class TestList(unittest.TestCase):
    ...
    def test_05(self):
        ht = HashTable(7)
        ht.insert("aaaaaaaa", 10)
        ht.insert("aaaaaaaaa", 12)
        ht.insert("aaaaaaaaaa", 14)
        self.assertEqual(ht.get_num_items(), 3)
        self.assertEqual(ht.get_table_size(), 7)
        self.assertEqual(ht.get_load_factor(), 3 / 7)
        self.assertEqual(ht.get_index("aaaaaaaa"), 3)
        self.assertEqual(ht.get_index("aaaaaaaaa"), 4)
        self.assertEqual(ht.get_index("aaaaaaaaaa"), 0)
        keys = ht.get_all_keys()
        keys.sort()
        self.assertEqual(keys, ["aaaaaaaa", "aaaaaaaaa", "aaaaaaaaaa"])
